...
class BeerAdapter: ListAdapter <Beers.BeersItem, BeerAdapter.MyViewHolder>(MyDiffUtil){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BeerAdapter.MyViewHolder {
